...
class RestaurantTest < Minitest::Test
  ...
  def test_open_for_lunch_if_after_twelve
    restaurant1 = Restaurant.new('10:00', 'Fuel Cafe')
    restaurant2 = Restaurant.new('16:00', 'Il Posto')

    refute restaurant1.open_for_lunch?

    assert restaurant2.open_for_lunch?
  end

  def test_menu_dish_names_returns_all_caps
    restaurant1 = Restaurant.new('10:00', 'Fuel Cafe')
    restaurant2 = Restaurant.new('16:00', 'Il Posto')
  ...
  def test_announce_closing_time_changes_format
